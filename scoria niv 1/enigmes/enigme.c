...
//affichage
void afficher_main(SDL_Surface *ecran,background_enigme *back,tete *Tete,userinterface *ui,int random,int *resultat,int *nbrvie,questions *question)
{
...
int enigme(int *nbrvie)
{
    SDL_Surface *ecran = NULL;
    int continuer =1,direction=0,frame_limit=0,random,random_question,resutlat=0,i;
...
//affichage
        ...
        afficher_main(ecran,&back,&Tete,&ui,random,&resultat,&nbrvie,&question);
        //printf("%d\n",nbrvie);
        SDL_Flip(ecran);
